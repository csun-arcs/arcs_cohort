...
const Starfield = {
  ...
  createStar() {
    ...
    // Random spawn distance from center
  ...
  update() {
    ...
    for (let i = 0; i < this.stars.length; i++) {
      ...
      // Calculate direction from star to origin
      const dx = this.originX - star.x;
      const dy = this.originY - star.y;
      ...
      // Reset star if it goes off screen or too close to origin
      if (
